...
target_layers = ['model_9_cv3','model_17_cv3', 'model_20_cv3', 'model_23_cv3']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="weights/IMSC/last_95.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='D:/temp/rddc2020-master/CAMdataset', help='input image path')
